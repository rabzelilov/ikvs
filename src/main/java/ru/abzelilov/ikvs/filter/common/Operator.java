...
public enum Operator {
    ...
    EQUAL {
        public <T> Predicate build(Root<T> root, CriteriaBuilder cb, StrainFilterRequest request, Predicate predicate) {
    ...
    public abstract <T> Predicate build(Root<T> root, CriteriaBuilder cb, StrainFilterRequest request, Predicate predicate);

    //with this piece of code I can use nested properties on my entities.
    public <T,V> Path<V> getPath(Root<T> root, StrainFilterRequest request) {
